...
// Non-coding practice bank for courses like Marketing, Soft Skills, etc.
// Boilerplate will be a JSON object containing the 'type' (quiz or case_study) and corresponding data
export const nonCodingPracticeBank = [
  {
    id: 'nc_mkt_001',
    title: 'Digital Marketing Fundamentals',
    description: 'A quick quiz to test your understanding of core digital marketing concepts.',
    difficulty: 'easy' as const,
    courseTags: ['marketing', 'digital marketing'],
    boilerplate: JSON.stringify({
      type: 'quiz',
      questions: [
        {
          text: 'What does SEO stand for?',
          options: ['Search Engine Optimization', 'Social Engagement Optimization', 'Search Environment Operations', 'Site Error Output'],
          correct: 0
        },
        {
          text: 'Which of these is a key metric for Email Marketing?',
          options: ['Bounce Rate', 'Open Rate', 'Click-Through Rate', 'All of the above'],
          correct: 3
        }
      ]
    }),
  ...
  },
  {
    ...
    description: 'Read the following scenario and provide your analysis on how to resolve the conflict.\n\nScenario:\nYou are a team leader. Two of your key developers are arguing over which tech stack to use for a critical new feature. Developer A wants React, and Developer B insists on Vue. The deadline is approaching rapidly.\n\nTask: Write a short paragraph on how you would de-escalate the situation and reach a decision.',
    difficulty: 'medium' as const,
    courseTags: ['soft skills', 'communication', 'leadership', 'management'],
    boilerplate: JSON.stringify({
      type: 'case_study',
      prompt: 'Write your analysis here. Consider both technical merits and team morale.'
    }),
    test_cases: '[]',
    constraints: 'Must be at least 50 words.'
  },
  {
    id: 'nc_data_001',
    title: 'Data Science Principles',
    description: 'Test your knowledge on basic data science definitions.',
    difficulty: 'easy' as const,
    courseTags: ['data science', 'machine learning', 'ai', 'data analytics'],
    boilerplate: JSON.stringify({
      type: 'quiz',
      questions: [
        {
          text: 'What is overfitting in Machine Learning?',
          options: ['When a model learns the training data too well, including noise', 'When a model performs poorly on training data', 'When the dataset is too large', 'When the model is under-trained'],
          correct: 0
        }
      ]
    }),
