...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="text-secondary font-inter pt-28 pb-20 min-h-screen bg-transparent">
      ...
      <div className="absolute top-20 left-1/4 w-72 h-72 bg-[#41c8df]/5 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-[#41c8df]/5 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <div className="bg-background/40 backdrop-blur-xl p-8 rounded-3xl border border-secondary/10 space-y-4">
              <p className="text-gray-300 leading-relaxed">
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <div className="bg-background/40 backdrop-blur-xl p-8 rounded-3xl border border-secondary/10 leading-relaxed space-y-4 text-gray-300">
              <p>
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <div className="bg-background/40 backdrop-blur-xl p-8 rounded-3xl border border-secondary/10 grid md:grid-cols-3 gap-6">
              <div className="flex items-center gap-4 text-gray-300">
                ...
                <div>
                  ...
                  <div className="text-sm font-semibold">+91 9966639869</div>
                </div>
              </div>
              <div className="flex items-center gap-4 text-gray-300">
                <div className="p-3 bg-[#41c8df]/10 text-[#41c8df] rounded-xl">
                ...
                <div>
                  <div className="text-xs text-gray-500 font-bold uppercase">Email Support</div>
                  <a href="mailto:contact@Cynexai.in" className="text-sm font-semibold hover:text-[#41c8df] transition-colors">contact@Cynexai.in</a>
                </div>
              </div>
              <div className="flex items-start gap-4 text-gray-300">
                ...
                <div>
                  ...
                  <div className="text-xs leading-tight">MIG-215, Rd Number 1, KPHB Kukatpally, Hyderabad, 500072</div>
                </div>
              </div>
            </div>
          </motion.div>
