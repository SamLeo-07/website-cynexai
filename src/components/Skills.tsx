  ...
  return (
    <section id="skills" className="py-20 relative bg-transparent overflow-hidden relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {skills.map((skill, index) => {
            ...
            return (
              <motion.div key={index} variants={itemVariants} className="h-full">
                ...
                >
                  <div className="group bg-background-100/40 backdrop-blur-xl rounded-2xl p-8 border border-secondary/10 dark:bg-gray-900/40 hover:border-[#41c8df]/60 transition-all duration-500 hover:shadow-[0_15px_40px_rgba(65,200,223,0.3)] text-center h-full relative overflow-hidden flex flex-col justify-start items-center">
        ...
        >
          <div className="bg-background-100/40 backdrop-blur-2xl rounded-3xl p-8 border border-secondary/10 dark:bg-gray-900/40 shadow-[0_8px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_10px_40px_rgba(65,200,223,0.15)] transition-all duration-500">
