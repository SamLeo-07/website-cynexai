...
const CoursesLanding = () => {
  ...
  return (
    <div className="text-secondary font-inter pt-28 pb-20 min-h-screen bg-transparent relative overflow-hidden">
      ...
      <div className="absolute top-20 left-1/4 w-80 h-80 bg-[#41c8df]/5 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-40 right-1/4 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <section className="text-center space-y-6 mb-16">
          ...
          >
            Master the Future of <span className="text-[#41c8df] bg-clip-text">Technology</span>
          </motion.h1>
          ...
          >
            <div className="flex items-center gap-3 bg-secondary/5 border border-secondary/15 px-6 py-3 rounded-2xl">
              ...
              <div className="text-left">
                <div className="text-sm font-black text-white">Live Classes</div>
                <div className="text-xs text-gray-400">Interactive & Hands-on</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-secondary/5 border border-secondary/15 px-6 py-3 rounded-2xl">
              <Users className="w-5 h-5 text-[#41c8df]" />
              <div className="text-left">
                <div className="text-sm font-black text-white">100% Placement</div>
                <div className="text-xs text-gray-400">Dedicated Hiring Partners</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-secondary/5 border border-secondary/15 px-6 py-3 rounded-2xl">
              <ShieldCheck className="w-5 h-5 text-[#41c8df]" />
              <div className="text-left">
                <div className="text-sm font-black text-white">ISO Certified</div>
                <div className="text-xs text-gray-400">Industry-Aligned Quality</div>
              </div>
            </div>
          </motion.div>
        </section>
                      ...
                      >
                        <div className="relative bg-background/40 backdrop-blur-xl rounded-3xl overflow-hidden border border-secondary/10 group-hover/card:border-[#41c8df]/60 transition-all duration-500 shadow-xl group-hover/card:shadow-[0_20px_50px_rgba(65,200,223,0.2)] h-full flex flex-col transform-style-3d">
                          ...
                          <div className="p-6 flex-grow flex flex-col transform-style-3d">
                            ...
                            <p className="text-gray-400 mb-6 line-clamp-2 text-sm leading-relaxed transform transition-transform duration-500 group-hover/card:translate-z-[20px]">
                              {course.description}
                            </p>
                            ...
                            <div className="grid grid-cols-3 gap-2 py-3 px-4 bg-secondary/5 rounded-2xl border border-secondary/10 mb-6 transform transition-transform duration-500 group-hover/card:translate-z-[25px] text-xs">
                              <div className="flex flex-col items-center justify-center text-center border-r border-secondary/10">
                                ...
                                <span className="font-bold text-white text-[10px] sm:text-xs">{course.duration}</span>
                              </div>
                              <div className="flex flex-col items-center justify-center text-center border-r border-secondary/10">
                                <Users className="w-4 h-4 text-[#41c8df] mb-1" />
                                <span className="font-bold text-white text-[10px] sm:text-xs">{course.students}</span>
                              </div>
                              <div className="flex flex-col items-center justify-center text-center">
                                <Star className="w-4 h-4 text-yellow-400 mb-1 animate-pulse" />
                                <span className="font-bold text-white text-[10px] sm:text-xs">{course.rating}</span>
                              </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-1.5 mb-6 mt-auto transform transition-transform duration-500 group-hover/card:translate-z-[20px]">
                              ...
                              {skills.length > 3 && (
                                <span className="px-2 py-1 bg-secondary/5 text-gray-400 font-medium rounded-md text-[10px] border border-secondary/10">
                                  +{skills.length - 3}
                                </span>
                              )}
                            </div>
                            ...
                            {/* Button CTA */}
                            <div className="transform transition-transform duration-500 group-hover/card:translate-z-[40px]">
                              <Link
                                to={`/course/${course.id}`}
                                className="w-full relative overflow-hidden group/btn bg-[#41c8df] text-black py-3 px-4 rounded-xl font-bold text-center transition-all duration-300 flex items-center justify-center hover:scale-[1.01] active:scale-[0.98] shadow-lg hover:shadow-[0_10px_20px_rgba(65,200,223,0.3)]"
                              >
                                ...
                                <span className="relative z-10 flex items-center justify-center group-hover/btn:text-secondary transition-colors duration-300 text-xs uppercase tracking-widest font-black">
                                  View Syllabus
