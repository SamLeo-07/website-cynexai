            ...
            <AnimatePresence mode="wait">
              ...
              >
                <TiltCard scale={1.02} tiltMaxAngleX={10} tiltMaxAngleY={10} className="w-full group/review">
                  <div className="bg-background-100/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-secondary/10 shadow-[0_8px_30px_rgba(0,0,0,0.12)] group-hover/review:shadow-[0_20px_50px_rgba(65,200,223,0.3)] transition-all duration-500 w-full relative overflow-hidden transform-style-3d">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 transform-style-3d">
                      ...
                      <div className="flex-1 text-center md:text-left transform-style-3d">
                        ...
                        {/* Review Text */}
                        <p className="text-slate-600 dark:text-gray-300 text-lg md:text-xl italic leading-relaxed transform transition-transform duration-500 group-hover/review:translate-z-[40px]">
