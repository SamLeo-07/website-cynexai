    ...
    <div className="min-h-screen bg-transparent pt-32 pb-20 px-4 relative z-10">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-secondary/70 max-w-2xl mx-auto leading-relaxed mb-12">
            Join our interactive online sessions and learn from industry experts in real-time.
          </p>

          <div className="bg-secondary/5 rounded-2xl border border-secondary/10 p-12 text-secondary/70 font-medium tracking-wide">
