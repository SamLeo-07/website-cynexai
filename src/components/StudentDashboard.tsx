...
const StudentDashboard = ({ 
  ...
  const { totalXp, level, xpProgress, nextLevelXp } = useMemo(() => {
    ...
    let xp = enrollments.length * 100 + sandboxXp + mockTestXp;
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <motion.div variants={itemVariants} className="space-y-6">
          {/* XP Level Card */}
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="w-14 h-14 rounded-full bg-white/10 flex items-center justify-center border-2 border-indigo-500/30">
                  <span className="text-2xl font-black text-indigo-400">{level}</span>
                </div>
              </div>
              
              <div className="space-y-2 mb-6">
                <div className="flex justify-between text-[10px] text-secondary/40 font-black uppercase tracking-widest">
                ...
                <div className="flex justify-between text-[9px] text-secondary/60 font-bold">
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex-1 bg-white/5 rounded-lg p-4 text-center border border-white/5">
                  ...
                  <p className="text-[9px] font-bold text-secondary/40 uppercase tracking-widest mt-0.5">Total XP</p>
                </div>
                <div className="flex-1 bg-white/5 rounded-lg p-4 text-center border border-white/5">
                  <Flame size={18} className="text-orange-400 mx-auto mb-1" />
                  <p className="text-lg font-black text-white">{streakDays}</p>
                  <p className="text-[9px] font-bold text-secondary/40 uppercase tracking-widest mt-0.5">Day Streak</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-background-100 border border-secondary/10 rounded-xl p-8 shadow-sm">
          ...
          <div className="space-y-8">
            <div className="relative pl-6 border-l-2 border-indigo-500">
              <p className="text-sm font-black text-secondary mb-1">Weekly AI Briefing</p>
              <p className="text-xs text-secondary/60 font-medium">New resources added to module 4</p>
            </div>
            <div className="relative pl-6 border-l-2 border-secondary/10">
              <p className="text-sm font-black text-secondary mb-1">Certification Drive</p>
              <p className="text-xs text-secondary/60 font-medium">Exam slots opening next Monday</p>
            </div>
            <div className="relative pl-6 border-l-2 border-secondary/10">
              <p className="text-sm font-black text-secondary mb-1">Community Meetup</p>
              <p className="text-xs text-secondary/60 font-medium">Virtual networking session this Friday</p>
            </div>
          </div>
        </div>
