      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg md:text-xl text-slate-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12 text-left">
              <motion.div variants={itemVariants}>
                <Tilt3DCard className="bg-background-100/80 backdrop-blur-md p-8 rounded-2xl shadow-[0_0_30px_rgba(65,200,223,0.1)] hover:shadow-[0_0_40px_rgba(65,200,223,0.2)] hover:border-[#41c8df]/40 border border-secondary/10 transition-all duration-300 h-full">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <motion.div key={i} variants={itemVariants}>
                  <Tilt3DCard className="bg-background-100/80 backdrop-blur-md p-6 rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.5)] text-center hover:shadow-[0_0_30px_rgba(65,200,223,0.2)] hover:border-[#41c8df]/40 border border-secondary/10 transition-all duration-300 h-full">
